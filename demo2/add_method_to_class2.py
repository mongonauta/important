...
if __name__ == '__main__':
    spec = importlib.util.find_spec('demo2.add_method_to_class2')
    ...
    sys.modules['demo2.add_method_to_class2'] = current_module
    ...
    setattr(current_module.Hello, 'new_run', current_module.new_run)
